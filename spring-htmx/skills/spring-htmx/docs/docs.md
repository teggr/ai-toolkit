...
|---------------------------------------------------------------------------------------|---------------|----------------------|----------------------------------------------------------------------------------------|
| [5.1.0](https://github.com/wimdeblauwe/htmx-spring-boot/releases/tag/5.1.0)           | 4.0.3         | 17                   | [README.md](https://github.com/wimdeblauwe/htmx-spring-boot/blob/5.1.0/README.md)     |
