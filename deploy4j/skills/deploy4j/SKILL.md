---
name: deploy4j
description: Reference skill for deploy4j installation, bootstrap configuration, secrets setup, and deployment workflows using CLI-first discovery with website fallback.
user-invocable: false
---

This skill provides a practical guide for setting up and using [deploy4j](https://deploy4j.dev/), with a CLI-first approach for up-to-date details.
